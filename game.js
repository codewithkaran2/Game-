...
function drawGame() {
    ...
    if (!player1.isDead) ctx.fillStyle = player1.color, ctx.fillRect(player1.x, player1.y, player1.width, player1.height);
    if (!player2.isDead) ctx.fillStyle = player2.color, ctx.fillRect(player2.x, player2.y, player2.width, player2.height);

    bullets.forEach(bullet => { ctx.fillStyle = bullet.color; ctx.fillRect(bullet.x, bullet.y, bullet.width, bullet.height); });
